              ...
              <ul class="space-y-2 font-medium">
                  ...
                  <li>
                      <Link to="/cms-desain-ku" class="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                          ...
                          <span class="ml-3 font-semibold">Manajemen Pesanan</span>
                      </Link>
                  </li>
                  <li>
                      <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                          ...
                          <span class="ml-3 font-semibold">Manajemen Desain</span>
                          <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">99</span>
                      </a>
                  </li>
                  <li>
                      <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                          ...
                          <span class="ml-3 font-semibold">Tugas Manajemen Desain</span>
                      </a>
                  </li>
