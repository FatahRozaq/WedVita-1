      ...
      <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div className="h-full px-3 py-4 overflow-y-auto bg-wedvita-sidebar-dark">
              ...
              <ul className="space-y-2 font-medium">
                  ...
                  <li>
                      <Link to="/cms-user-profile" className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                  ...
                  <li>
                      <Link onClick={onLogout} className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
