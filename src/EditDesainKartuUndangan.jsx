                    ...
                    <div class="mb-4">
                        <label for="dropzone-file" class="mb-4 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
                            ...
                            <div class="mb-6">
                                ...
                                <input name="designName" type="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Nama Anda" value={invitationDesigns.designName} onChange={ev => setInvitationDesigns({...invitationDesigns, designName: ev.target.value})} required></input>
                            </div>
                            <div class="mb-6">
                                <label for="name" class="block mb-2 text-sm font-semibold text-gray-900">Harga</label>
                                <input name="price" type="number" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Harga Desain" value={invitationDesigns.price} onChange={ev => setInvitationDesigns({...invitationDesigns, price: ev.target.value})} required></input>
                            </div>
                            <div class="mb-6">
                                <label for="name" class="block mb-2 text-sm font-semibold text-gray-900">Tautan</label>
                                <input name="designLink" type="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Tautan Desain" value={invitationDesigns.designLink} onChange={ev => setInvitationDesigns({...invitationDesigns, designLink: ev.target.value})} required></input>
                            </div>
                            <div class="mb-6">
