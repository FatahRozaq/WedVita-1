        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-wedvita-sidebar-dark">
          ...
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3 font-semibold">Manajemen Undangan</span>
              </a>
            </li>
