  ...
  return (
    <Slider {...settings}>
      <div>
        ...
        <div className="px-5 font-normal grid-item mb-4 leading-8 tracking-tight text-wedvita-text-light md:text-1setxl text-center">
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="px-5 font-normal grid-item mb-8 leading-8 tracking-tight text-wedvita-text-light md:text-1setxl text-center ">
