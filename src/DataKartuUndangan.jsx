                    ...
                    <div className="mb-4">
                        <label for="dropzone-file" className="mb-4 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
                            ...
                            <div className="mb-6">
                                ...
                                <input ref={designNameRef} name="designName" type="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Nama Anda" required></input>
                            </div>
                            <div className="mb-6">
                                <label for="name" className="block mb-2 text-sm font-semibold text-gray-900">Harga</label>
                                <input ref={priceRef} name="price" type="number" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Harga Desain" required></input>
                            </div>
                            <div className="mb-6">
                                <label for="name" className="block mb-2 text-sm font-semibold text-gray-900">Tautan</label>
                                <input ref={designLinkRef} name="designLink" type="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Tautan Desain" required></input>
                            </div>
                            <div className="mb-6">
                                <label for="message" className="block mb-2 text-sm font-medium text-gray-900">Deskripsi</label>
                                <textarea ref={designDescriptionRef} name="designDescription" id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Leave a comment..."></textarea>
                            </div>                            
