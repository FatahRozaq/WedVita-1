    ...
    return (
        <div className="body-font font-poppins bg-wedvita-sidebar-dark">
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-wedvita-sidebar-dark dark:bg-gray-800">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                                ...
                                <span className="ml-3 font-semibold">Profil</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                                ...
                                <span className="ml-3 font-semibold">Pilih Desain</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                                ...
                                <span className="ml-3 font-semibold">Pesanan</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">99</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                                ...
                                <span className="ml-3 font-semibold">Atur Undangan</span>
                            </a>
                        </li>
                        ...
                        <main className="flex-1 p-4">
                                        ...
                                        <Menu as="div" className="relative inline-block text-left">
                                            <div>
                                                <Menu.Button className="flex mb-4 items-center text-sm font-medium text-gray-900 rounded-full hover:text-blue-600 dark:hover:text-blue-500 md:mr-0 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-white">
                                                    ...
                                                    <div className="font-extrabold">Julya Lemniscate</div>
                            ...
                            <div className="bg-white p-4 mb-4 rounded shadow">
                                <div className="flex items-center mb-2">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <div className="text-xl text-gray-700 font-bold">Julya</div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white p-4 mb-4 rounded shadow">
                                <div className="mb-4">
                                    ...
                                    <form>
                                        <div className="mb-6">
                                            <label for="name" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Nama</label>
                                    ...
                                    <form>
                                        <div className="mb-6">
                                            <label for="email" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Email</label>
                                        ...
                                        <div className="mb-6">
                                            <label for="password" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Password</label>
