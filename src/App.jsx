        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-5">
              ...
              <button type="button" className="text-white bg-wedvita-purple-unhover hover:bg-wedvita-purple-hovered focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5">Register</button>
            </ul>
          </nav>
        </div>
      </header>
